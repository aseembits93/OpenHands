...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            # Use list comprehension for message serialization, conditionally
            ...
            # Only deepcopy when mocking function calling, else skip for perf
            ...
            if self.config.log_completions:
                ...
                _d = {
                    'messages': messages,
                    'response': resp if not mock_function_calling else non_fncall_response,
                    'args': args,
                    'kwargs': {
                        k: v
    ...
    def format_messages_for_llm(self, messages: Message | list[Message]) -> list[dict]:
        ...
        # Use list comprehension for message serialization
