...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        # Precompute features to avoid redundant lookups
        ...
        features = self._features  # reused, already cached
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if messages_list and isinstance(messages_list[0], Message):
                # Avoid unnecessary extra conversion/copy: use list comprehension directly
            ...
            original_fncall_messages = messages.copy()
            mock_fncall_tools = None

            # Use cached features to prevent repeated get_features calls
            ...
            # Use shallow copy for resp unless mutation occurs downstream
            non_fncall_response = resp.copy()
    ...
    def is_caching_prompt_active(self) -> bool:
        ...
        if not self.config.caching_prompt:
            return False
        # Use cached features object
        return self._features.supports_prompt_cache
